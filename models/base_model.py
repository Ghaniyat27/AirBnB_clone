...
class BaseModel:
    ...
    serialization and deserialization of instance's
    """
    ...
    def __str__(self):
        """String rep of the BaseModel Instance's"""
    ...
    def save(self):
        """updates 'updated_at' instance's with the current datetime"""
        self.updated_at = datetime.now()
        models.storage.save()

    def to_dict(self):
        """Return dictionary representation of the BaseModel class."""
