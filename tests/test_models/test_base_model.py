...
"""
    This folder implements every test for the base_model.
"""
...
class TestBase(unittest.TestCase):
    """
        Examining the base class model.
    """
    ...
    def test_id_type(self):
        """
            Verifies the type of id is string.
        """
        self.assertEqual("<class 'str'>", str(type(self.my_model.id)))

    def test_ids_differ(self):
        """
            Verifies that the id between two instance's are different.
        """
        new_model = BaseModel()
    ...
    def test_save(self):
        """
            verifies that after updating the instance; the dates differ in the
    ...
    def test_str_overide(self):
        """
            verifies that the right message get's printed.
        """
        backup = sys.stdout
    ...
    def test_to_dict_type(self):
        """
            verifies that the to_dict method return's type.
        """
    ...
    def test_to_dict_class(self):
        """
            verifies that the __class__ key exist's.
        """
    ...
    def test_to_dict_type_updated_at(self):
        """
            verifies the type of the value of updated_at.
        """
    ...
    def test_to_dict_type_created_at(self):
        """
            verifies the type of value of created_at.
        """
    ...
    def test_kwargs_instantiation(self):
        """
            Examine that an instance is created using the
            key value pair.
        """
    ...
    def test_type_created_at(self):
        """
            Examine that the new_model updated_at
    ...
    def test_type_updated_at(self):
        """
            Examine that the new_model created_at
            data type is datetime.
        """
        my_model_dict = self.my_model.to_dict()
        new_model = BaseModel(my_model_dict)
    ...
    def test_compare_dict(self):
        """
            Examine that the new_model and my_models
