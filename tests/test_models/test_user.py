...
class UserCase(unittest.TestCase):
    """This Tests instances and methods from user class"""
    ...
    def test_user_inheritance(self):
        """This test if User is a subclass of BaseModel"""
        self.assertIsInstance(self.u, User)

    def testHasAttributes(self):
        """This verify if attributes exist"""
    ...
    def test_types(self):
        """This tests if the type of the attribute is the correct one"""
